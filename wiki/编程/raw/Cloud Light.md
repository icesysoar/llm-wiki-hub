...
The [Volume Arrival Time SOP](https://www.sidefx.com/docs/houdini/nodes/sop/volumearrivaltime.html "Computes a speed-defined travel time from source points to voxels.") is used to compute how long it takes to reach any particular voxel from one of the seed points. Voxels that are only reachable through low speeds will thus have higher values as they take longer to get to.
...
The incoming density fields are passed through. A [Volume Visualization SOP](https://www.sidefx.com/docs/houdini/nodes/sop/volumevisualization.html "Adjusts attributes for multi-volume visualization.") will also be used to set the light field to light volume, letting you see the result in the viewport.
...
Disables all processing of the incoming density field, using it directly as a speed function for the [Volume Arrival Time SOP](https://www.sidefx.com/docs/houdini/nodes/sop/volumearrivaltime.html "Computes a speed-defined travel time from source points to voxels.").
...
Controls the range of the density to speed conversion. The lowest value will go to `1 - contrast/2`, the highest to `contrast/2`.
...
-    [![](https://www.sidefx.com/docs/houdini/icons/SOP/volumearrivaltime.svg) Volume Arrival Time](https://www.sidefx.com/docs/houdini/nodes/sop/volumearrivaltime.html)
-    [![](https://www.sidefx.com/docs/houdini/icons/SOP/volumevisualization.svg) Volume Visualization](https://www.sidefx.com/docs/houdini/nodes/sop/volumevisualization.html)