...
content_hash: "d7a265b9d05a"
---
静态求解器DOP是一个求解器，它在每个时间段对其对象不做任何处理。
### Parameters
Although the behavior of the object is the same as if no solver was attached to the object, it can be necessary to use this solver when using a [Switch Solver](https://www.sidefx.com/docs/houdini/nodes/dop/switchsolver.html) or [Blend Solver](https://www.sidefx.com/docs/houdini/nodes/dop/blendsolver.html). When using those solvers, there is no way to turn off solving other than using this Static Solver.
...
See also
!Switch Solver#Static Solver Dynamics
!Blend Solver#Static Solver Dynamics
