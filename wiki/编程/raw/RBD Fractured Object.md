...
content_hash: "0b2cc78acc26"
---
从SOP几何图形中创建一些RBD对象。这些单独的RBD对象是由几何体名称属性创建的。
### Parameters

The RBD Fractured Object DOP creates multiple [RBD Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdobject.html "Creates an RBD Object from SOP Geometry.") inside the DOP simulation. It takes the geometry from the given SOP Path and breaks it into pieces according to the Group Mask.
Note
The RBD Fractured Object will make one object for each group. If you have meta groups such as inside and outside, try using `piece*` instead of `*`.

1.  Select the geometry to convert to an RBD fractured object.
2.  Define the pieces to be fractured. For example, using the [Shatter tool](https://www.sidefx.com/docs/houdini/shelf/shatter.html "Shatters the input geometry into multiple pieces.").
3.  Select the object and click the ![](https://www.sidefx.com/docs/houdini/icons/DOP/rbdfracturedobject.svg)[RBD Fractured Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdfracturedobject.html "Creates a number of RBD Objects from SOP Geometry. These individual RBD Objects are created from the geometry name attributes. ") tool on the **Rigid Bodies** tab.
4.  Choose whether to use an [RBD Packed Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdpackedobject.html " Creates a single DOP object from SOP Geometry that represents a number of RBD Objects.") or an [RBD Fractured Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdfracturedobject.html "Creates a number of RBD Objects from SOP Geometry. These individual RBD Objects are created from the geometry name attributes. ").
    RBD Packed Objects are useful for large simulations since they are much faster, use less memory, and are smaller to write to disk. They can also be influenced by [POP Forces](https://www.sidefx.com/docs/houdini/dopparticles/forces.html), such as drag. Packed Objects can not interact with other solvers such as cloth and fluids. They also only work with [Constraint Networks](https://www.sidefx.com/docs/houdini/nodes/dop/constraintnetwork.html "Constrains pairs of RBD objects together according to a polygon network."), such as the one created by the ![](https://www.sidefx.com/docs/houdini/icons/PARTS/glue.svg)[Glue Adjacent](https://www.sidefx.com/docs/houdini/shelf/gluenetwork.html "Creates glue constraints between adjacent RBD objects.") shelf tool.
![](https://www.sidefx.com/docs/houdini/images/shelf/rbd_fracture_object_before.jpg) ![](https://www.sidefx.com/docs/houdini/images/shelf/rbd_fracture_object_after.jpg)
Note
Once you convert geometry to an RBD fractured object you can only [transform, rotate, and scale](https://www.sidefx.com/docs/houdini/basics/handles.html) it when it is on the first frame.
## Attributes
...
## EXAMPLES
Load Launch
[ShatterDebris](https://www.sidefx.com/docs/houdini/examples/nodes/dop/rbdfracturedobject/ShatterDebris.html)Example for [RBD Fractured Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdfracturedobject.html) dynamics node
...
Load Launch
[ShatterGlass](https://www.sidefx.com/docs/houdini/examples/nodes/dop/rbdfracturedobject/ShatterGlass.html)Example for [RBD Fractured Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdfracturedobject.html) dynamics node
...
Load Launch
[StackedBricks](https://www.sidefx.com/docs/houdini/examples/nodes/dop/rbdfracturedobject/StackedBricks.html)Example for [RBD Fractured Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdfracturedobject.html) dynamics node
...
[/nodes/dop/rbdglueobject](https://www.sidefx.com/docs/houdini/nodes/dop/rbdglueobject.html)
 ...
 [![](https://www.sidefx.com/docs/houdini/icons/DOP/rbdobject.svg) RBD Object](https://www.sidefx.com/docs/houdini/nodes/dop/rbdobject.html)