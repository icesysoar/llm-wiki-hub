...
content_hash: "89d3f96442eb"
---
在卷/ VDB基元中添加或生成噪声。
### Parameters
The Volume Noise Fog SOP provides a simple interface for quickly adding coherent noise to voxel values, reducing the need to create VOP networks or write VEX code. All of the models provided by the [Unified Noise VOP](https://www.sidefx.com/docs/houdini/nodes/vop/unifiednoise.html "Presents a unified interface and uniform output range for all the noise types available in VEX.") can be used with this node.
