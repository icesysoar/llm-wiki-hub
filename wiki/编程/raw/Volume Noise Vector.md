...
content_hash: "cecf7ee73958"
---
在向量卷/ VDB中添加或生成噪声。
### Parameters
The Volume Noise Vector SOP provides a simple interface for quickly adding coherent noise to voxel values, reducing the need to create VOP networks or write VEX code. All of the models provided by the [Unified Noise VOP](https://www.sidefx.com/docs/houdini/nodes/vop/unifiednoise.html "Presents a unified interface and uniform output range for all the noise types available in VEX.") can be used with this node.
## PARAMETERS
General
Blend
...
-    [![](https://www.sidefx.com/docs/houdini/icons/SOP/volumenoisesdf.svg) Volume Noise SDF](https://www.sidefx.com/docs/houdini/nodes/sop/volumenoisesdf.html)
-    [![](https://www.sidefx.com/docs/houdini/icons/SOP/volumenoisefog.svg) Volume Noise Vector](https://www.sidefx.com/docs/houdini/nodes/sop/volumenoisefog.html)