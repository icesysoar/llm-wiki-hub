...
content_hash: "cee8d51dbca2"
---
产生适合地形高度图的噪声。
### Parameters
Terrain noise generates noise patterns that can be used for landscapes. The noise can be post-processed by a ramp or extracting a slice of the noise.
If an input is connected, the RGB values are used to sample the noise space. Feeding noise into noise can produce some complex patterns.
## Noise
Noise Type
