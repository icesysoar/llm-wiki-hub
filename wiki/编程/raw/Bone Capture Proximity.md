...
content_hash: "7cc195f65b2d"
---
通过赋予基于到骨骼距离的捕捉权重来支持Bone Deform。
### Parameters
...
For its second input, it can either be an a set of [Capture Region](https://www.sidefx.com/docs/houdini/nodes/sop/cregion.html "Supports Capture and Deform operation by creating a volume within which
