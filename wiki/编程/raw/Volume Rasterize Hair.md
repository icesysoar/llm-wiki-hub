...
To avoid excessive memory use for the temporary resample points, this parameter limits the number of primitives that are resampled and rasterized at a time. Internally, a [ForEach SOP](https://www.sidefx.com/docs/houdini/nodes/sop/foreach.html) iterates over each batch.
...
-    [![](https://www.sidefx.com/docs/houdini/icons/SOP/volumerasterizeparticles.svg) Volume Rasterize Particles](https://www.sidefx.com/docs/houdini/nodes/sop/volumerasterizeparticles.html)