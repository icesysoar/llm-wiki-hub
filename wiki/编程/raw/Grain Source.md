...
content_hash: "f07d9bd9f945"
---
为颗粒模拟产生最初的基础粒子
### Parameters
The Grain Source SOP generates emission particles suitable for the [POP Grains](https://www.sidefx.com/docs/houdini/nodes/dop/popgrains.html "A POP node that applies sand grain interaction to particles.") particle solver.
...
-    [![](https://www.sidefx.com/docs/houdini/icons/DOP/sandsolver.svg) POP Grains](https://www.sidefx.com/docs/houdini/nodes/dop/popgrains.html)